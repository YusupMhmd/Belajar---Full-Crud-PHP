...
$total_barang   = get_count("SELECT COUNT(*) FROM barang");
$total_mahasiswa = get_count("SELECT COUNT(*) FROM mahasiswa");
$total_akun     = get_count("SELECT COUNT(*) FROM akun");
$total_admin    = get_count("SELECT COUNT(*) FROM akun WHERE level = 1");
          ...
          <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="bi bi-list-task"></i> <?= $title ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
